...
<%
// エラーメッセージ表示処理
String errorMsg =(String)request.getAttribute("errorm");
if (errorMsg != null) {
%>
                <p style="text-align:center;color:red;"><%=errorMsg %></p>
<% } %>
                <form action="NewAcountController" method="post">
                    ...
                    <div class="row">
                        <div class="col-xs-8 col-xs-offset-2">
                            <button type="submit" class="btn btn-primary btn-block btn-success">新規登録</button>
                        </div>
                    </div>
                </form>
            </div>
